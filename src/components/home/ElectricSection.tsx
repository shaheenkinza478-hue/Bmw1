            ...
            <motion.div variants={itemVariants}>
              <Link href="/electric">
                ...
                >
                  ...
                  <motion.div
                    className="absolute -inset-0.5 bg-gradient-to-r from-blue-600 via-green-500 to-blue-600 rounded-full blur opacity-0 group-hover:opacity-100 transition duration-500"
                    animate={{
