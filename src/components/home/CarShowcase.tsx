...
import SectionTitle from '@/components/ui/SectionTitle'  // ✅ YEH SAHI IMPORT HAI
...
const CarShowcase = () => {
  ...
  return (
    ...
    >
      {/* Background Animations - Same as FeaturedModels */}
      ...
      <div className="container-padding mx-auto relative z-10">
        {/* Section Header - Using SectionTitle component */}
        <SectionTitle
          title="BMW Showcase"
        ...
        <div className="relative mt-12">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-12">
                ...
                >
                  ...
                  <motion.p
                    ...
                    className="text-gray-300 text-lg mb-6 max-w-2xl leading-relaxed"
                  >
                  ...
                  >
                    <Link href={`/models/${cars[currentIndex].slug}`}>
                      ...
                      >
                        ...
                        <Button 
                          size="lg"
                          className="relative bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-bold px-10 py-4 rounded-full text-lg overflow-hidden group border-0 shadow-2xl shadow-blue-600/50"
                        >
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.9 }}
            onClick={prevSlide}
            className="absolute left-4 top-1/2 transform -translate-y-1/2 bg-white/10 hover:bg-blue-600/50 text-white p-4 rounded-full backdrop-blur-sm border border-white/20 transition-all duration-300 z-20"
          >
            <ChevronLeft size={24} />
          </motion.button>
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.9 }}
            onClick={nextSlide}
            className="absolute right-4 top-1/2 transform -translate-y-1/2 bg-white/10 hover:bg-blue-600/50 text-white p-4 rounded-full backdrop-blur-sm border border-white/20 transition-all duration-300 z-20"
          >
